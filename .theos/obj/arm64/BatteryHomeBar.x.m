...
@class SpringBoard; @class MTLumaDodgePillView; @class MTStaticColorPillView; 


#line 115 "BatteryHomeBar.x"
...
__attribute__((used)) static NSLayoutConstraint * _logos_method$Universal$MTStaticColorPillView$batteryPositionXConstraint(MTStaticColorPillView * __unused self, SEL __unused _cmd) { return (NSLayoutConstraint *)objc_getAssociatedObject(self, (void *)_logos_method$Universal$MTStaticColorPillView$batteryPositionXConstraint); }; __attribute__((used)) static void _logos_method$Universal$MTStaticColorPillView$setBatteryPositionXConstraint(MTStaticColorPillView * __unused self, SEL __unused _cmd, NSLayoutConstraint * rawValue) { objc_setAssociatedObject(self, (void *)_logos_method$Universal$MTStaticColorPillView$batteryPositionXConstraint, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
__attribute__((used)) static NSLayoutConstraint * _logos_method$Tweak12$MTLumaDodgePillView$batteryPositionXConstraint(MTLumaDodgePillView * __unused self, SEL __unused _cmd) { return (NSLayoutConstraint *)objc_getAssociatedObject(self, (void *)_logos_method$Tweak12$MTLumaDodgePillView$batteryPositionXConstraint); }; __attribute__((used)) static void _logos_method$Tweak12$MTLumaDodgePillView$setBatteryPositionXConstraint(MTLumaDodgePillView * __unused self, SEL __unused _cmd, NSLayoutConstraint * rawValue) { objc_setAssociatedObject(self, (void *)_logos_method$Tweak12$MTLumaDodgePillView$batteryPositionXConstraint, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
__attribute__((used)) static NSLayoutConstraint * _logos_method$Tweak13$MTLumaDodgePillView$batteryPositionXConstraint(MTLumaDodgePillView * __unused self, SEL __unused _cmd) { return (NSLayoutConstraint *)objc_getAssociatedObject(self, (void *)_logos_method$Tweak13$MTLumaDodgePillView$batteryPositionXConstraint); }; __attribute__((used)) static void _logos_method$Tweak13$MTLumaDodgePillView$setBatteryPositionXConstraint(MTLumaDodgePillView * __unused self, SEL __unused _cmd, NSLayoutConstraint * rawValue) { objc_setAssociatedObject(self, (void *)_logos_method$Tweak13$MTLumaDodgePillView$batteryPositionXConstraint, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
